                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="col-xs-8 col-sm-8">
                        <div id="totalExp" class="progress progress-striped active">
                            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: ${user.getPercent()}%">${user.getPercent()}%
                            ...
                            <div class="col-xs-6 col-xs-offset-5 col-sm-4 col-sm-offset-0">
                                <div id="measuresExp" class="progress progress-striped active">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%">5/5
                                                <span class="sr-only"></span>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
